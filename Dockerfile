...
ENTRYPOINT ["java", "-cp", "modules/swagger-codegen-cli/target/swagger-codegen-cli.jar:output/typescript-angular2-swagger-codegen/target/typescript-angular2-swagger-codegen-1.0.jar"]
